...
#setwd('C:/Users/quang/Downloads/Documents/Data 332/R-programming/Uber Project/UberData')
# Getting the data
...
# Turning week of each month from 1-6, not consecutively
...
# Pivot table to display trips by the hour, month, day, week, weekday, and base. 
pivot_table <- df %>%
